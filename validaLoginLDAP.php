...
/*$ldap_server = "email.unimed-erechim.com.br";
$dominio = "@unimed-erechim.com.br"; //Dominio local ou global
$user = "salete.silva" . $dominio;
$ldap_porta = "389";
$ldap_pass = "teste";
...
$user = 'douglas';
$password = 'adm123';
$host = 'email.unimed-erechim.com.br';
$domain = 'unimed-erechim.com.br';
$basedn = 'dc=unimed-erechim,dc=com,dc=br';
$group = 'TI';
